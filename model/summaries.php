<?php 
    ...
    <br><br>
    BOSA has a 10-point practically-oriented list of solutions that includes grants for first-time employees who are graduates, a BIG, building five nuclear power stations within 10 years, etc.
    ...
    The PA has been criticized for anti-immigrant rhetoric, which some perceive as xenophobic. 
    <br><br>
    It received 0.04% of the vote in 2019 and 0.87% of the vote in 2021.
    ...
    $mk = <<<'TAG'
    uMkhonto we Sizwe (MK), meaning “Spear of the Nation”, similar to the ANC-aligned paramilitary group of the Apartheid years, was founded in 2023. Disgraced Former President Jacob Zuma is seen as the de-facto leader of the party, seeing that he’s the face of the party and after he announced publicly in December 2023 that he’ll remain an ANC member yet he won’t campaign for it in the upcoming elections but rather for the MK Party.
    
    <br><br>

    The MK Party has a mostly populist ideology with much RET (Radical Economic Transformation) and conservative influences. Recently, Zuma has publicly stated that if MK were to come to power, they would send pregnant teens to a facility on Robben Island and also show opposition to same-sex relationships and marriages, calling it a disgrace. He also said South Africa should use “African law” instead of “Dutch law”.
    TAG;
